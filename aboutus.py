...
def toggle_menu():
  ...
  ## options.set("category")
    #optmnu = tk.OptionMenu(root, options, "Mens","Women","Kids")
...
# Unisex_btn = tk.Button(head_frame, text='Unisex', font=('bold', 13), bd=0, bg='#158aff', fg='white',
#                         activeforeground='#158aff', activebackground='white', command='')
# Unisex_btn.place(x=900, y=13)
