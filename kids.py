...
img = Image.open("Little Boys Fashion Cloths.png")
resizeimg = img.resize((310,700))
newimg = ImageTk.PhotoImage(resizeimg)
Label(frame1, image=newimg, border=0).place(x=0, y=0)

heading = tk.Label(item_frame, text="Rs. 899                Product no. 009",bg="#fff", font=("Microsoft Yahei UI Light", 15))
...
img1 = Image.open("Beautiful Ankara Gowns Styles For Kids – Flipmemes_com.png")
resizeimg = img1.resize((310,700))
newimg1 = ImageTk.PhotoImage(resizeimg)
Label(item, image=newimg1, border=0).place(x=0, y=0)

heading = tk.Label(item_frame, text="Rs. 999                Product no. 010",bg="#fff", font=("Microsoft Yahei UI Light", 15))
...
img2 = Image.open("8f028537-c607-4c05-b4d6-019fe71cdec9.png")
resizeimg = img2.resize((310,700))
newimg2 = ImageTk.PhotoImage(resizeimg)
Label(frame3, image=newimg2, border=0).place(x=0, y=0)

heading = tk.Label(item_frame, text="Rs. 1999               Product no. 011",bg="#fff", font=("Microsoft Yahei UI Light", 15))
...
img3 = Image.open("Khloé Kardashian Admits Her Sisters Had Help Designing the Kids Line.png")
resizeimg = img3.resize((310,700))
newimg3 = ImageTk.PhotoImage(resizeimg)
Label(frame4, image=newimg3, border=0).place(x=0, y=0)

heading = tk.Label(item_frame, text="Rs. 999                Product no. 012",bg="#fff", font=("Microsoft Yahei UI Light", 15))
